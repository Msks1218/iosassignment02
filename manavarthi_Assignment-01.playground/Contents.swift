...
var y = 25.0
// y = x
 //getting error"Cannot assign value of type 'Int' to type 'Double'
...
var myone : String = "sanjay"
if(myone.hasPrefix("a")){
    print(myone)
}
else{
    print("A \(myone)")
...
var str1 : String = "sanjay"

    var endresult = str1
    let first_char = endresult.remove(at: endresult.startIndex)
    let findLast = endresult.index(before: endresult.endIndex)
    let last_char = endresult.remove(at: findLast)
    endresult.append(first_char)
    endresult.insert(last_char, at: (endresult.startIndex))
    
    print(endresult)
print("------------------------------------")
//5.c) Declare a String Swift and print them in the reverse order.
var myone1 : String = "sanjay"
print(String(myone1.reversed() ))
print("------------------------------------")
...
var stri1 = "ababa"
    if stri1.hasPrefix("a")
    {
        stri1.removeFirst()
    }
    
    if stri1.hasSuffix("a")
    {
        stri1.removeLast()
    }
    print(stri1)
